...
.{ .name = .{ .items = { 67, 72, 51, 50, 86, 50, 48, 120 }, .capacity = 128, .allocator = .{ .ptr = anyopaque@7ffdf5c92980, .vtable = .{ ... } } }, .version = .{ .items = { 49, 46, 49 }, .capacity = 128, .allocator = .{ .ptr = anyopaque@7ffdf5c92980, .vtable = .{ ... } } }, .description = .{ .items = { 67, 72, 51, 50, 86, 50, 48, 120, 32, 86, 105, 101, 119, 32, 70, 105, 108, 101 }, .capacity = 128, .allocator = .{ .ptr = anyopaque@7ffdf5c92980, .vtable = .{ ... } } }, .cpu = null, .address_unit_bits = 8, .max_bit_width = 32, .reg_default_size = null, .reg_default_reset_value = null, .reg_default_reset_mask = null, .peripherals = .{ .items = { .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }