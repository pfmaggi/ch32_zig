...
.{ .name = .{ .items = { 67, 72, 51, 50, 86, 48, 48, 51 }, .capacity = 128, .allocator = .{ .ptr = anyopaque@7ffefd0f7a60, .vtable = .{ ... } } }, .version = .{ .items = { 49, 46, 50 }, .capacity = 128, .allocator = .{ .ptr = anyopaque@7ffefd0f7a60, .vtable = .{ ... } } }, .description = .{ .items = { 67, 72, 51, 50, 86, 48, 48, 51, 32, 86, 105, 101, 119, 32, 70, 105, 108, 101 }, .capacity = 128, .allocator = .{ .ptr = anyopaque@7ffefd0f7a60, .vtable = .{ ... } } }, .cpu = null, .address_unit_bits = 8, .max_bit_width = 32, .reg_default_size = null, .reg_default_reset_value = null, .reg_default_reset_mask = null, .peripherals = .{ .items = { .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... }, .{ ... } }, .capacity = 26, .allocator = .{ .ptr = anyopaque@7ffefd0f7a60, .vtable = .{ ... } } }, .interrupts = .{ .unmanaged = .{ .metadata = hash_map.HashMapUnmanaged(u32,svd.Interrupt,hash_map.AutoContext(u32),80).Metadata@