...
pub const types = struct {
    ...
    pub const USBFS = extern struct {
        ...
        R8_UDEV_CTRL__R8_UHOST_CTRL: RegisterRW(
            packed struct(u8) {
        ...
        R8_UEP2_3_MOD__R8_UH_EP_MOD: RegisterRW(
            packed struct(u8) {
        ...
        R16_UEP2_DMA__R16_UH_RX_DMA: RegisterRW(
            packed struct(u16) {
                /// padding [0:15]
                _padding: u16 = 0,
            },
        ...
        R16_UEP3_DMA__R16_UH_TX_DMA: RegisterRW(
            packed struct(u16) {
                /// padding [0:15]
                _padding: u16 = 0,
            },
        ...
        R8_UEP1_CTRL__R8_UH_SETUP: RegisterRW(
            packed struct(u8) {
                /// MASK_UEP_T_RES [0:1]
                /// bit mask of handshake response type for USB endpoint X transmittal (IN)
                MASK_UEP_T_RES: u2 = 0,
        ...
        R8_UEP2_T_LEN__R8_UH_EP_PID: RegisterRW(
            packed struct(u8) {
                /// MASK_UH_ENDP [0:3]
        ...
        R8_UEP2_CTRL__R8_UH_RX_CTRL: RegisterRW(
            packed struct(u8) {
                /// MASK_UEP_T_RES [0:1]
                /// bit mask of handshake response type for USB endpoint X transmittal (IN)
                MASK_UEP_T_RES: u2 = 0,
        ...
        R8_UEP3_T_LEN__R8_UH_TX_LEN: RegisterRW(
            packed struct(u8) {
                /// padding [0:7]
                _padding: u8 = 0,
            },
        ...
        R8_UEP3_CTRL__R8_UH_TX_CTRL: RegisterRW(
            packed struct(u8) {
                /// MASK_UEP_T_RES [0:1]
                /// bit mask of handshake response type for USB endpoint X transmittal (IN)
                MASK_UEP_T_RES: u2 = 0,
